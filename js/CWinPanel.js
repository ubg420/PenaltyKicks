function CWinPanel(oSpriteBg) {
    ...
    this._init = function (oSpriteBg) {
        ...
        _oTitleTextStoke = new createjs.Text("", "80px " + FONT_GAME, TEXT_COLOR_STROKE);
        _oTitleTextStoke.x = CANVAS_WIDTH / 2;
        _oTitleTextStoke.y = CANVAS_HEIGHT_HALF - 170;
        _oTitleTextStoke.textAlign = "center";
        _oTitleTextStoke.outline = 5;

        _oGroup.addChild(_oTitleTextStoke);

        _oTitleText = new createjs.Text("", "80px " + FONT_GAME, TEXT_COLOR);
