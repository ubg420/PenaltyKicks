function CInterface() {
    ...
    this.createAnimText = function (szText, iSize, bStrobo, szColor, szColorStroke) {//TEXT_BALL_OUT, 90, false, TEXT_COLOR_1, TEXT_COLOR_STROKE
        ...
        var oTextStroke = new createjs.Text(szText, iSize + "px " + SECONDARY_FONT, szColorStroke);
        oTextStroke.x = 0;
        oTextStroke.y = 0;
        ...
        var oText = new createjs.Text(oTextStroke.text, iSize + "px " + SECONDARY_FONT, szColor);
        oText.x = 0;
        oText.y = 0;
